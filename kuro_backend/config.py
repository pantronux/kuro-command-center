...
# V6.0 Perf Optimization: Use 1.5-flash for background tasks like memory extraction/classification
# to save latency and token costs, while preserving 3-flash for the primary responses.
CLASSIFIER_MODEL = "gemini-1.5-flash"  # For fact classification and internal routing tasks
